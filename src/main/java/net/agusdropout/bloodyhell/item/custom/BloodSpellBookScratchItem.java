    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        if (level instanceof ServerLevel serverLevel) {
                if(open) {
                    ...
                    // 🔹 Crear y spawnear las 3 entidades
                    BloodSlashEntity centerSlash = new BloodSlashEntity(level, baseX, baseY, baseZ, 30.0F, player, -yaw);
                    BloodSlashEntity leftSlash = new BloodSlashEntity(level, leftX, baseY, leftZ, 30.0F, player, -yaw - 15);  // Izquierda
                    BloodSlashEntity rightSlash = new BloodSlashEntity(level, rightX, baseY, rightZ, 30.0F, player, -yaw + 15); // Derecha
