...
public class ScarletSpeckledFishEntity extends AbstractFish implements GeoEntity, Bucketable {
    private AnimatableInstanceCache factory = new SingletonAnimatableInstanceCache(this);
    private PlayState predicate(AnimationState animationState) {
        if(animationState.isMoving()) {
            animationState.getController().setAnimation(RawAnimation.begin().then("animation.scarletspeckledfish.swim", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }

        animationState.getController().setAnimation(RawAnimation.begin().then("animation.scarletspeckledfish.idle", Animation.LoopType.LOOP));
        return PlayState.CONTINUE;
    }
    @Override
    ...
    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(ScarletSpeckledFishEntity.class, EntityDataSerializers.BOOLEAN);

    public ScarletSpeckledFishEntity(EntityType<? extends AbstractFish> p_27461_, Level p_27462_) {
        super(p_27461_, p_27462_);
        this.moveControl = new ScarletSpeckledFishEntity.FishMoveControl(this);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new ScarletSpeckledFishEntity.FishSwimGoal(this));
    ...
    static class FishMoveControl extends MoveControl {
        private final ScarletSpeckledFishEntity fish;

        FishMoveControl(ScarletSpeckledFishEntity p_27501_) {
            super(p_27501_);
            this.fish = p_27501_;
        }
    ...
    static class FishSwimGoal extends RandomSwimmingGoal {
        ...
        public FishSwimGoal(ScarletSpeckledFishEntity p_27505_) {
