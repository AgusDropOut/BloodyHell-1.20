...
public class KeyBinding {
    public static final String KEY_CATEGORY_TUTORIAL = "key.category.bloodyhell.tutorial";
    public static final String KEY_DRINK_WATER = "key.bloodyhell.drink_blood";
