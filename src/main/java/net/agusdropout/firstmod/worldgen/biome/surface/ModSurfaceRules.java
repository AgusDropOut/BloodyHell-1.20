...
public class ModSurfaceRules {
    private static final SurfaceRules.RuleSource BLOOD_DIRT_DIRT = makeStateRule(ModBlocks.BLOOD_DIRT_BLOCK.get());
    ...
    public static SurfaceRules.RuleSource makeRules() {
        ...
        SurfaceRules.RuleSource grassSurface = SurfaceRules.sequence(SurfaceRules.ifTrue(isAtOrAboveWaterLevel, BLOOD_GRASS_BLOCK), BLOOD_DIRT_DIRT);
