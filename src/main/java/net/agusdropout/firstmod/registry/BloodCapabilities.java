package net.agusdropout.firstmod.registry;

import net.agusdropout.firstmod.FirstMod;
import net.agusdropout.firstmod.capability.BloodPortalCapability;
...
public class BloodCapabilities {
    ...
    public static void attachCapabilities(AttachCapabilitiesEvent<Entity> event) {
        if (event.getObject() instanceof Player player) {
            ...
            event.addCapability(new ResourceLocation(FirstMod.MODID, "blood_portal"), provider);
        }
    }
